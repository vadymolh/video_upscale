...
Для роботи програми необхідно встановити наступні бібліотеки через командну строку:
...
Тепер у відкритому вікні зображаємо прямокутник і спостерігаємо за процесом апскейлу та трекінгу

Для зміни відео можна відкрити файл zone.py та на 11 строці ввести шлях до бажаного відеофайлу
